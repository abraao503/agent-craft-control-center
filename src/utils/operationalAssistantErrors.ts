...
const OPERATIONAL_ASSISTANT_ERROR_MESSAGES: Record<string, string> = {
  ...
  ASSISTANT_NOT_FOUND: "O agente não existe mais neste ambiente.",
  ASSISTANT_IN_USE:
    "Desative as rotas e finalize os atendimentos deste agente antes de desativá-lo.",
  ...
  PROVIDER_CREDENTIAL_REQUIRED:
    "Informe a credencial do provedor para ativar o agente.",
