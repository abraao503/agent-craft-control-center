...
// Define a type for the content used in the form
...
const KnowledgeContent = ({
  ...
  const handleFileUpload = async () => {
    ...
    try {
      ...
      // 3. Add the newly created content to selected contents
      addContent({
        id: newContent.id,
      ...
      if (document.getElementById("upload") instanceof HTMLInputElement) {
